...
import CertificateGenerator from './Components/Employee Dashboard/CertificateGenerator.js';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path='/certificate-generator/platform/' element={<CertificateGenerator/>}></Route>
