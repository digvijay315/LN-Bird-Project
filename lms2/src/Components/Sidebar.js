        ...
        <div className="dashboard-list">
          ...
          <div className="list-options">
            <div className="accordion accordion-flush" id="accordionFlushExample">
              ...
              <EditNoteIcon/>
                <button className='dropdown-toggle-button menu-btn'> 
                <MenuItem label="Assign Survey" link="/assignQuize" />
                </button>
              </div> */}
              {/* <div className='dash-options'>
              <EditNoteIcon/>
              ...
              {/* <div className='dash-options'>
                <EditNoteIcon/>
                <button className='dropdown-toggle-button menu-btn'> 
                <MenuItem label="Assessment Result" link="/showAssessmentResult" />
                </button>
              </div> */}
              {/* <div className='dash-options'>
                <EditNoteIcon/>
                <button className='dropdown-toggle-button menu-btn'> 
                <MenuItem label="Survey Result" link="/showQuizResult" />
                </button>
              </div> */}
              <div className='dash-options'>
                <EditNoteIcon/>
              ...
              {/* <div className='dash-options'>
                <EditNoteIcon/>
                <button className='dropdown-toggle-button menu-btn'> 
                <MenuItem label="Request For Training" link="/trainingrequestform" />
                </button>
              </div>
              <div className='dash-options'>
                <EditNoteIcon/>
              ...
              <div className='dash-options'>
                <EditNoteIcon/>
                <button className='dropdown-toggle-button menu-btn'> 
                <MenuItem label="RFT Pending for Approval" link="/pendingtrf" />
                </button>
              </div>
              <div className='dash-options'>
                <EditNoteIcon/>
              ...
              <div className='dash-options'>
                <EditNoteIcon/>
                <button className='dropdown-toggle-button menu-btn'> 
                <MenuItem label="HR Recruitment" link="/HRdashboard" />
                </button>
              </div>
              <div className='dash-options'>
                <EditNoteIcon/>
