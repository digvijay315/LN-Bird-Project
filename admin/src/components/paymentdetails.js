...
const allColumns = [
        { id: 'sno', name: '#' },
        { id: 'type', name: 'Type' },
        { id: 'paymentfor', name: 'Payment For' },
        { id: 'date', name: 'Date' },
        { id: 'customername', name: 'Customer Name' },
        { id: 'ledgerac', name: 'Ledger A/C 9' },
        { id: 'paymenttype', name: 'Payment Type' },
        { id: 'bankname', name: 'Bank Name' },
        { id: 'chequeno', name: 'Chq No' },
        { id: 'infavour', name: 'In Favour' },
        { id: 'netamount', name: 'Net Amount' },
        { id: 'tds', name: 'TDS' },
        { id: 'taxamount', name: 'Tax Amount' },
        { id: 'totalamount', name: 'Total Amount' },
        { id: 'finalamount', name: 'Final Amount' },
  ...
  setischecked(e.target.checked)
    ...
    return ( 
      ...
      <div style={{marginTop:"80px",paddingLeft:"80px",backgroundColor:"white",display:"flex",paddingTop:"10px",paddingBottom:"10px"}}>
        ...
        <h3 style={{marginLeft:"10px",cursor:"pointer"}} onClick={pagereload}>Payment </h3>
      ...
      <input id="search" type="text" disabled={!ischecked} className="form-control form-control-sm form-control form-control-sm-sm" placeholder="Tupe to filter by lead name" style={{width:"25%"}} onChange={(e)=>setsearchdata(e.target.value)} onKeyDown={handlekeypress1}/>
