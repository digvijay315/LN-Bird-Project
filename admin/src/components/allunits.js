        ...
        <div style={{
          ...
          {item.values && item.values.length > 0 && (
            <div style={{ maxHeight: 130, overflowY: "auto", background: "#fcfdff", padding: "6px 8px", borderRadius: 7 }}>
              ...
              <div style={{marginTop:"2px",backgroundColor:"white",height:"60px",paddingLeft:"80px",display:"flex",gap:"20px",paddingTop:"10px",position:"sticky",top:"50px",zIndex:"111"}}>
                      ...
                      <ul style={{ listStyleType: 'none', margin: 0, padding: '10px' }}>
                        {allunitColumns.slice(2).map((col) => (
                          <li key={col.id} style={{ padding: '5px 0' }}>
                            <input
                              type="checkbox"
                              checked={visibleColumns3.some((visibleCol) => visibleCol.id === col.id)}
