function Dashboard() {
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider bg_cover pt-150" style={{backgroundImage:"images/slider/s-1.jpg"}} data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider bg_cover pt-150" style={{backgroundImage:"images/slider/s-2.jpg"}} 
         data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
        ...
        <div class="single-slider bg_cover pt-150" style={{backgroundImage:"images/slider/s-3.jpg"}} data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
    ...
    <section id="video-feature" class="bg_cover pt-60 pb-110" style={{backgroundImage:"images/bg-1.jpg"}}>
        <div class="container">
    ...
    <section id="testimonial" class="bg_cover pt-115 pb-115" data-overlay="8" style={{backgroundImage:"images/bg-2.jpg"}}>
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
